...
//admin imports
import AdminAccountItem from './components/admin/accounts/adminAccountOption.js';
import AdminMainPage from './components/admin/index.js';

//supplier imports
import SupplierMainPage from './components/supplier/index.js'
import SupplierAccountItem from './components/supplier/account/supplierAccountOption.js';

//delivery imports
import DeliveryMainPage from './components/delivery/index.js'
import DeliveryAccountItem from './components/delivery/account/deliveryAccountOption.js';
 ...
 updateCart=()=>{
  ...
  renderAdmin(){
    return (
      ...
      <div className="main-content">
          <Switch>
            <Route exact path="/" render={(props)=> <AdminMainPage token={this.state.token}/> 
            }> 
            </Route>
  ...
  renderSupplier(){
    return (
      ...
      <div className="main-content">
          <Switch>
            <Route exact path="/" render={(props)=> <SupplierMainPage token={this.state.token}/> 
            }> 
            </Route>
  ...
  renderDelivery(){
    return (
      ...
      <div className="main-content">
          <Switch>
            <Route exact path="/" render={(props)=> <DeliveryMainPage token={this.state.token} /> 
            }> 
            </Route>
          </Switch>
        </div>
    ...
    return (<>
        <div className="main-content">
          <Switch>
            ...
            <EditProfile {...props} token={this.state.token} user={this.state.user} udata={this.state.udata} onUserUpdated={this.onUserUpdated}/> }></Route>
            ...
            <Container className="nav-items">
              { this.state.user ? (
                ...
                {this.state.role === 'customer' ? (
                  ...
                  <AccountItem user={this.state.user} udata={this.state.udata ? (this.state.udata):(null)} logout={this.logout}>Accounts</AccountItem>
                  </>
                  ):(this.state.role === 'admin' ? (
                    <>
                      <AdminAccountItem user={this.state.user} logout={this.logout}>Accounts</AdminAccountItem>
                    </>
                    ):(this.state.role === 'supplier' ? (
                       <>
                      <SupplierAccountItem user={this.state.user} logout={this.logout}>Accounts</SupplierAccountItem>
                    </>
                      ):(this.state.role === 'delivery' ? (
                        <>
                          <DeliveryAccountItem user={this.state.user} logout={this.logout}>Accounts</DeliveryAccountItem>
                        </>
                        ):(null))))}
                                  </>
              ) : (
